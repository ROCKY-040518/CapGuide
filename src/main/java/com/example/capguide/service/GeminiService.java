...
public class GeminiService {
    ...
    private static final String SYSTEM_PROMPT = """
            ...
            ★ 사용자가 IT, 소프트웨어, 공학, 프로그래밍을 명시적으로 언급하지 않은 경우:
              ...
              - 예시: 문학 → 텍스트 비평, 문헌 분석, 비교문학 방법론 / 철학 → 논증 분석, 사상사 연구 /
               체육 → 체력 측정 도구, 영상 분석, 코칭 방법론 / 미술 → Adobe Creative Suite, 전시 기획
            ...
            [
              {
                ...
                "detailedSchedule": ["1~2주차: 주제 선정 및 선행연구/자료 조사", "3~5주차: 연구 설계 및 환경 구축",
                 "6~10주차: 핵심 연구/개발/제작 수행", "11~13주차: 결과 분석 및 검증", "14~16주차: 최종 발표 준비 및 보고서 작성"],
